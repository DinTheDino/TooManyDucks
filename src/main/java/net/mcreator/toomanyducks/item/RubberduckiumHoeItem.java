...
public class RubberduckiumHoeItem extends HoeItem {
	public RubberduckiumHoeItem() {
		super(new Tier() {
			public int getUses() {
				return 2380;
			}
		...
		}, 0, -3f, new Item.Properties().tab(ToomanyducksModTabs.TAB_TOO_MANY_DUCKS));
		setRegistryName("rubberduckium_hoe");
	}
}
